...
const MOVE_DATA = {
  ...
  plank:    { hold: 3, move: 0.01, a: pose(-84, -0.62, { shoulder_l: j(90), shoulder_r: j(90), elbow_l: j(-6), elbow_r: j(-6) }), b: null },
  squat:    { hold: 0.5, move: 1.3, a: pose(0, 0, {}), b: pose(-8, -0.16, { hip_l: j(80), hip_r: j(80), knee_l: j(-95), knee_r: j(-95), ankle_l: j(14), ankle_r: j(14) }) },
  pushup:   { hold: 0.5, move: 1.1, a: pose(-84, -0.60, { shoulder_l: j(90, 0, 8), shoulder_r: j(90, 0, -8), elbow_l: j(-8), elbow_r: j(-8) }), b: pose(-84, -0.72, { shoulder_l: j(78, 0, 35), shoulder_r: j(78, 0, -35), elbow_l: j(-78), elbow_r: j(-78) }) },
