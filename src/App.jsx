...
const MOVE_DATA = {
  ...
  pushup:   { hold: 0.5, move: 1.1, contacts: ["hand_l", "hand_r", "foot_l", "foot_r"], a: pose(-76.6, -0.502, { shoulder_l: j(90, 0, -6), shoulder_r: j(90, 0, 6), elbow_l: j(-8), elbow_r: j(-8) }), b: pose(-85.3, -0.619, { shoulder_l: j(65, 0, -35), shoulder_r: j(65, 0, 35), elbow_l: j(-60), elbow_r: j(-60) }) },
