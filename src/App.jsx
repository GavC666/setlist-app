...
const BONES = {
  ...
  spine:     { parent: "pelvis",   offset: [0, 0.16, 0] },
  chest:     { parent: "spine",    offset: [0, 0.16, 0] },
  neck:      { parent: "chest",    offset: [0, 0.14, 0] },
  head:      { parent: "neck",     offset: [0, 0.10, 0] },
  shoulder_l:{ parent: "chest",    offset: [-0.17, 0.08, 0] },
  elbow_l:   { parent: "shoulder_l", offset: [0, -0.27, 0] },
  wrist_l:   { parent: "elbow_l",  offset: [0, -0.25, 0] },
  shoulder_r:{ parent: "chest",    offset: [0.17, 0.08, 0] },
  elbow_r:   { parent: "shoulder_r", offset: [0, -0.27, 0] },
  wrist_r:   { parent: "elbow_r",  offset: [0, -0.25, 0] },
  hip_l:     { parent: "pelvis",   offset: [-0.11, -0.02, 0] },
  knee_l:    { parent: "hip_l",    offset: [0, -0.45, 0] },
  ankle_l:   { parent: "knee_l",   offset: [0, -0.42, 0] },
  hip_r:     { parent: "pelvis",   offset: [0.11, -0.02, 0] },
  knee_r:    { parent: "hip_r",    offset: [0, -0.45, 0] },
  ankle_r:   { parent: "knee_r",   offset: [0, -0.42, 0] },
};
// [radius, isTorso] per segment for capsule thickness — purely visual.
const SEGMENT_RADIUS = {
  spine: 0.075, chest: 0.075, neck: 0.045, head: 0.09,
  shoulder_l: 0.03, elbow_l: 0.045, wrist_l: 0.035,
  shoulder_r: 0.03, elbow_r: 0.045, wrist_r: 0.035,
  hip_l: 0.04, knee_l: 0.06, ankle_l: 0.05,
  hip_r: 0.04, knee_r: 0.06, ankle_r: 0.05,
};
...
const MOVE_DATA = {
  standing: { hold: 1.4, move: 1.2, a: pose(0, 0, { shoulder_l: j(0, 0, 4), shoulder_r: j(0, 0, -4) }), b: pose(0, 0, { shoulder_l: j(0, 0, -4), shoulder_r: j(0, 0, 4) }) },
  carry:    { hold: 0.5, move: 0.6, a: pose(0, 0, { hip_l: j(12), knee_l: j(-12), hip_r: j(-12), knee_r: j(12), shoulder_l: j(-6), shoulder_r: j(-6) }), b: pose(0, 0, { hip_l: j(-12), knee_l: j(12), hip_r: j(12), knee_r: j(-12), shoulder_l: j(-6), shoulder_r: j(-6) }) },
  plank:    { hold: 3, move: 0.01, a: pose(-90, -0.85, { shoulder_l: j(70), shoulder_r: j(70), elbow_l: j(-6), elbow_r: j(-6) }), b: null },
  squat:    { hold: 0.5, move: 1.3, a: pose(0, 0, {}), b: pose(-8, -0.16, { hip_l: j(80), hip_r: j(80), knee_l: j(-95), knee_r: j(-95), ankle_l: j(14), ankle_r: j(14) }) },
  pushup:   { hold: 0.5, move: 1.1, a: pose(-90, -0.85, { shoulder_l: j(70), shoulder_r: j(70), elbow_l: j(-6), elbow_r: j(-6) }), b: pose(-90, -0.85, { shoulder_l: j(70), shoulder_r: j(70), elbow_l: j(-90), elbow_r: j(-90) }) },
  lunge:    { hold: 0.5, move: 1.2, a: pose(0, 0, {}), b: pose(0, -0.12, { hip_l: j(35), knee_l: j(-90), hip_r: j(-25), knee_r: j(-90) }) },
  hinge:    { hold: 0.5, move: 1.3, a: pose(0, 0, {}), b: pose(0, 0, { spine: j(-65), knee_l: j(-20), knee_r: j(-20) }) },
  bridge:   { hold: 0.5, move: 1.1, a: pose(-90, -0.85, { hip_l: j(70), hip_r: j(70), knee_l: j(-90), knee_r: j(-90) }), b: pose(-90, -0.70, { hip_l: j(70), hip_r: j(70), knee_l: j(-90), knee_r: j(-90) }) },
  ...
  curl:     { hold: 0.5, move: 0.9, a: pose(0, 0, { elbow_l: j(-10), elbow_r: j(-10) }), b: pose(0, 0, { elbow_l: j(-140), elbow_r: j(-140) }) },
  press:    { hold: 0.5, move: 1.0, a: pose(0, 0, { shoulder_l: j(40), shoulder_r: j(40), elbow_l: j(-90), elbow_r: j(-90) }), b: pose(0, 0, { shoulder_l: j(170), shoulder_r: j(170), elbow_l: j(-10), elbow_r: j(-10) }) },
  ...
  situp:    { hold: 0.5, move: 1.1, a: pose(-90, -0.85, { hip_l: j(70), hip_r: j(70), knee_l: j(-90), knee_r: j(-90) }), b: pose(-90, -0.85, { hip_l: j(70), hip_r: j(70), knee_l: j(-90), knee_r: j(-90), spine: j(-65) }) },
  legraise: { hold: 0.5, move: 1.2, a: pose(-90, -0.85, {}), b: pose(-90, -0.85, { hip_l: j(80), hip_r: j(80) }) },
  jack:     { hold: 0.4, move: 0.45, a: pose(0, 0, {}), b: pose(0, 0.05, { shoulder_l: j(0, 0, 80), shoulder_r: j(0, 0, -80), hip_l: j(0, 0, 20), hip_r: j(0, 0, -20) }) },
...
function Mannequin3D({ poseKey, accent, size = 220 }) {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      const floor = new THREE.Mesh(new THREE.CircleGeometry(1.3, 32), new THREE.MeshStandardMaterial({ color: 0x000000, opacity: 0.12, transparent: true }));
      floor.rotation.x = -Math.PI / 2;
      floor.position.y = 0.001;
      scene.add(floor);

      const accentColor = new THREE.Color(accent);
      const bodyColor = new THREE.Color("#8a8578");
      ...
      SEGMENTS.forEach((id) => {
        ...
        const color = isTorso || isHead ? bodyColor : accentColor;
        const mat = new THREE.MeshStandardMaterial({ color, roughness: 0.55, metalness: 0.05 });
        const mesh = new THREE.Mesh(isHead ? headGeo : cylGeo, mat);
        scene.add(mesh);
        meshes[id] = mesh;
      });
      ...
      function tick(now) {
        ...
        SEGMENTS.forEach((id) => {
          ...
          if (id === "head") {
            ...
            mesh.scale.setScalar(SEGMENT_RADIUS.head);
            return;
          }
          ...
          const r = SEGMENT_RADIUS[id] || 0.04;
      ...
      stateRef.current = { renderer, scene, raf: requestAnimationFrame(tick) };
      } catch (e) {
  ...
  return (
    <div className="mannequin-wrap" style={{ width: size, height: size }}>
      <canvas ref={canvasRef} className="mannequin-canvas" />
      {errMsg && (
...
function ExerciseSheet({ ex, onClose, onAdd, accent }) {
  if (!ex) return null;
  return (
    <div className="sheet-overlay" onClick={onClose}>
      <div className="sheet" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="sheet-actions">
          ...
          {onAdd && <button className="btn-primary" onClick={() => { onAdd(ex); onClose(); }}><Plus size={16} /> Add to routine</button>}
        </div>
      </div>
    </div>
  );
...
/* ============================== LIBRARY TAB ============================== */
function LibraryTab({ onAdd, accent }) {
    ...
    <div className="tab-pane">
      ...
      <div className="ex-list">
        {filtered.slice(0, 200).map((ex) => (
          <button key={ex.id} className="ex-row" onClick={() => setDetail(ex)}>
            ...
            {onAdd && <span className="ex-row-add" onClick={(e) => { e.stopPropagation(); onAdd(ex); }}><Plus size={18} /></span>}
          </button>
        ))}
      ...
      <ExerciseSheet ex={detail} onClose={() => setDetail(null)} onAdd={onAdd} accent={accent} />
    </div>
  );
}
      ...
      {pickerOpen && (
        <div className="sheet-overlay" onClick={() => setPickerOpen(false)}>
          <div className="sheet sheet-tall" onClick={(e) => e.stopPropagation()}>
            ...
            <LibraryTab onAdd={addExercise} accent={accent} />
          </div>
        </div>
      )}
    </div>
    ...
    <div className="tab-pane player">
      ...
      {phase === "rest" ? (
        ...
        <div className="player-center">
          <Mannequin3D poseKey={ex.poseKey} accent={accent} size={200} />
...
.player-center .mannequin-wrap{ margin-bottom:8px; }
...
.mannequin-wrap{ position:relative; border-radius:18px; overflow:hidden; background:var(--bg-elev2); flex-shrink:0; margin:0 auto; }
.mannequin-canvas{ width:100%; height:100%; display:block; }
.mannequin-error{ position:absolute; inset:0; display:flex; flex-direction:column; align-items:center; justify-content:center; gap:8px; text-align:center; padding:14px; font-size:11.5px; color:var(--text-dim); background:var(--bg-elev2); }
