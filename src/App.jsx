...
const BONES = {
  ...
  hand_l:    { parent: "wrist_l",  offset: [0, -0.015, -0.075] },
  ...
  hand_r:    { parent: "wrist_r",  offset: [0, -0.015, -0.075] },
...
const SEGMENT_RADIUS = {
  ...
  shoulder_l: 0.055, elbow_l: 0.050, wrist_l: 0.040, hand_l: 0.038,
  shoulder_r: 0.055, elbow_r: 0.050, wrist_r: 0.040, hand_r: 0.038,
...
const MOVE_DATA = {
  ...
  plank:    { hold: 3, move: 0.01, contacts: ["hand_l", "hand_r", "foot_l", "foot_r"], a: pose(-76.8, -0.504, { shoulder_l: j(90), shoulder_r: j(90), elbow_l: j(-6), elbow_r: j(-6) }), b: null },
  ...
  pushup:   { hold: 0.5, move: 1.1, contacts: ["hand_l", "hand_r", "foot_l", "foot_r"], a: pose(-76.6, -0.502, { shoulder_l: j(90, 0, -6), shoulder_r: j(90, 0, 6), elbow_l: j(-8), elbow_r: j(-8) }), b: pose(-75.3, -0.485, { shoulder_l: j(70, 0, -20), shoulder_r: j(70, 0, 20), elbow_l: j(-45), elbow_r: j(-45) }) },
