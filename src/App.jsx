...
const MOVE_DATA = {
  ...
  plank:    { hold: 3, move: 0.01, contacts: ["wrist_l", "wrist_r", "foot_l", "foot_r"], a: pose(-84, -0.62, { shoulder_l: j(90), shoulder_r: j(90), elbow_l: j(-6), elbow_r: j(-6) }), b: null },
  ...
  pushup:   { hold: 0.5, move: 1.1, contacts: ["wrist_l", "wrist_r", "foot_l", "foot_r"], a: pose(-84, -0.60, { shoulder_l: j(90, 0, -6), shoulder_r: j(90, 0, 6), elbow_l: j(-8), elbow_r: j(-8) }), b: pose(-84, -0.72, { shoulder_l: j(78, 0, -22), shoulder_r: j(78, 0, 22), elbow_l: j(-78), elbow_r: j(-78) }) },
