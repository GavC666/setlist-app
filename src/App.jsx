...
const SEGMENT_RADIUS = {
  ...
  hip_l: 0.065, knee_l: 0.078, ankle_l: 0.058,
  hip_r: 0.065, knee_r: 0.078, ankle_r: 0.058,
};
...
const MOVE_DATA = {
  ...
  pushup:   { hold: 0.5, move: 1.1, a: pose(-84, -0.60, { shoulder_l: j(90), shoulder_r: j(90), elbow_l: j(-8), elbow_r: j(-8) }), b: pose(-84, -0.72, { shoulder_l: j(84), shoulder_r: j(84), elbow_l: j(-75), elbow_r: j(-75) }) },
