...
const MOVE_DATA = {
  ...
  pushup:   { hold: 0.5, move: 1.1, a: pose(-90, -0.80, { shoulder_l: j(70), shoulder_r: j(70), elbow_l: j(-6), elbow_r: j(-6) }), b: pose(-90, -0.97, { shoulder_l: j(55), shoulder_r: j(55), elbow_l: j(-95), elbow_r: j(-95) }) },
  ...
  useEffect(() => {
    ...
    try {
      ...
      function autoFrame(world) {
        ...
        frameBox.expandByScalar(0.14); // padding so limbs/head aren't clipped at the edge
